    ...
    return (
        ...
        <div className="flex flex-col w-nine justify-center mx-auto">
            <div className="flex flex-col h-auto mx-auto justify-center w-nine lg:flex-row mt-20 mb-12">
                <div className="lg:w-150 my-auto w-full  lg:pl-24 py-5">
                    <img src={setIcons} className="w-full rounded-md" alt="" title="Icon - © Courtesy of MyGames" />
                </div>
        ...
        <div className="flex flex-col w-nine justify-center mx-auto mb-8 lg:pl-24 lg:pr-56">
            <p>
                ...
                I can't stress this enough, <span className="font-extrabold">use this list as a general guideline only</span>, 
                double check in #gear-comparisons on the <a href="https://discord.gg/7vhfVRm" alt="" className="text-purple-500 font-extrabold hover:underline">Hustle Prime Discord</a> server to make sure.
            </p>
        </div>
        ...
        <div className="flex flex-col justify-center w-nine mx-auto">
            ...
            <div className="flex flex-col h-auto mx-auto justify-center w-nine lg:flex-row mb-12">
                <div className=" lg:w-1/5 my-auto w-full  lg:pl-24 py-5">
                    <img src={Ashbringer} className="w-full rounded-md" alt="" title="Icon - © Courtesy of MyGames" />
                </div>
            ...
            <div className="flex flex-col h-auto mx-auto justify-center w-nine lg:flex-row mb-12">
                <div className=" lg:w-1/5 my-auto w-full lg:pl-24 py-5">
                    <img src={Paladin} className="w-full rounded-md" alt="" title="Icon - © Courtesy of MyGames" />
                </div>
                <div className="flex lg:w-4/5 flex-col text-center">
                    <div className="flex flex-col text-center lg:mx-12">
            ...
            <div className="flex flex-col h-auto mx-auto justify-center w-nine lg:flex-row mb-12">
                <div className=" lg:w-1/5 my-auto w-full  lg:pl-24 py-5">
                    <img src={Darkula} className="w-full rounded-md" alt="" title="Icon - © Courtesy of MyGames" />
                </div>
            ...
            <div className="flex flex-col h-auto mx-auto justify-center w-nine lg:flex-row mb-12">
                <div className=" lg:w-1/5 my-auto w-full  lg:pl-24 py-5">
                    <img src={Annihilator} className="w-full rounded-md" alt="" title="Icon - © Courtesy of MyGames" />
                </div>
                <div className="flex flex-col text-center  lg:w-4/5">
                    <div className="flex flex-col text-center lg:mx-12">
            ...
            <div className="flex flex-col h-auto mx-auto justify-center w-nine lg:flex-row mb-12">
                <div className=" lg:w-1/5 my-auto w-full  lg:pl-24 py-5">
                    <img src={Legionnaire} className="w-full rounded-md" alt="" title="Icon - © Courtesy of MyGames" />
                </div>
                <div className="flex flex-col text-center  lg:w-4/5">
                    <div className="flex flex-col text-center lg:mx-12">
            ...
            <div className="flex flex-col h-auto mx-auto justify-center w-nine lg:flex-row mb-12">
                <div className=" lg:w-1/5 my-auto w-full  lg:pl-24 py-5">
                    <img src={Bane} className="w-full rounded-md" alt="" title="Icon - © Courtesy of MyGames" />
                </div>
                <div className="flex flex-col text-center  lg:w-4/5">
                    <div className="flex flex-col text-center lg:mx-12">
            ...
            <div className="flex flex-col h-auto mx-auto justify-center w-nine lg:flex-row mb-12">
                <div className=" lg:w-1/5 my-auto w-full  lg:pl-24 py-5">
                    <img src={Storm} className="w-full rounded-md" alt="" title="Icon - © Courtesy of MyGames" />
                </div>
                <div className="flex flex-col text-center  lg:w-4/5">
                    <div className="flex flex-col text-center lg:mx-12">
