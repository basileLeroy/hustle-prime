        ...
        <div className="flex flex-col min-h-full h-auto mb-6">
            ...
            <div className="flex flex-col w-nine justify-center mx-auto">
                ...
                <div className="flex lg:flex-row flex-col w-nine h-12 justify-around mx-auto my-8 lg:px-24">
                    <button onClick={ChangeChoiceDisplay} className={choiceDisplay ? 'bg-gray-500 w-1/2 py-3 mx-4 rounded-xl text-center my-auto' : 'bg-gray-700 w-1/2 py-3 mx-4 rounded-xl text-center my-auto hover:bg-gray-500'}><p className="my-auto">Set Choices</p></ button>
                    <button onClick={ChangeGearDisplay} className={gearDisplay ? 'bg-gray-500 w-1/2 py-3 mx-4 rounded-xl text-center my-auto' : 'bg-gray-700 w-1/2 py-3 mx-4 rounded-xl text-center my-auto hover:bg-gray-500'}><p>Gear Choices</p></ button>
                </div>
