    ...
    return (
        <div className="flex flex-col min-h-full h-auto mb-6">
            ...
            <div className="relative flex flex-col lg:flex-row mx-auto brown-white bg-opacity-20 cursor-not-allowed mb-28">
                <div className="bg-gray-700 w-60 h-20 mx-20 rounded-br-xl rounded-tl-xl text-2xl text-center text-black">
                    <h3>Join as Visitor</h3>
                </div>
                <div className="bg-gray-700 w-60 h-20 mx-20 rounded-br-xl rounded-tl-xl text-2xl text-center text-black">
                <h3>Join as Member of Hustle Prime</h3>
                </div>
                <div className="hover:opacity-50 absolute top-0 bottom-0 left-0 right-0 bg-white opacity-0 border rounded-lg text-3xl text-center text-black">
                    <h3>Comming soon!</h3>
